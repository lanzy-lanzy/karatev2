...
def reports_export(request):
    ...
    belt_rank = request.GET.get("belt_rank", "").strip()
    evaluation_status = request.GET.get("evaluation_status", "").strip()
    achievement_type = request.GET.get("achievement_type", "").strip()
    match_type = request.GET.get("match_type", "").strip()
    min_rating = request.GET.get("min_rating", "").strip()
    status_filter = request.GET.get("status_filter", "").strip()
    include_evaluations = request.GET.get("include_evaluations") == "true"
